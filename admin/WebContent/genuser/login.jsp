...
<title><bean:message key="label.generalist"/>&nbsp;<bean:message key="label.login"/></title>
            ...
            <div class="tabberlive">
                <ul class="tabbernav">    
                    <li id="login" class="tabberactive">
                       <html:link action="user.spl"><bean:message key="label.login"/></html:link>
                    </li>
                    <li id="register" class="tabberinactive">
                        <html:link action="userreg.spl"><bean:message key="label.register"/></html:link>
                    </li>
                </ul>
            </div>
        </td>
                            ...
                            <table id="dataTable" width="100%" border="0" class="inputsubtable" cellpadding="2" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="specCriteriaTextLabels">
                                        ...
                                        <html:messages id="error" property="errors.label.locpassword" message="true">
                                            &nbsp;<font color="red"><bean:write name="error"/></font>
                                        </html:messages>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <html:hidden name="LoginForm" property="userType" value="SPEC"/>
                                ...
                                <tr><td colspan="2">&nbsp;</td></tr>
                                <tr>
                                    <td colspan="2" class="specCriteriaTextLabelsLeft">
                                        <font color="red">*</font>&nbsp;<bean:message key="label.regmsg"/>
                                    </td>
                                </tr>
