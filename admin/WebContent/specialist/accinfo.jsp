                    ...
                    <td colspan="2">
                        <table id="dataTable" width="100%" border="0" class="inputsubtable" cellpadding="0" cellspacing="1">
                            ...
                            <tr>
                                ...
                                <td class="specCriteriaTextLabels">
                                    <bean:write name="SpecialistForm" property="createDt"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="specCriteriaTextLabelsRight" width="300">
                            ...
                            <tr>
                                <td class="specCriteriaTextLabelsRight" width="300">
                                    <bean:message key="label.download"/>&nbsp;<bean:message key="label.url"/>:&nbsp;&nbsp;
                                </td>
                                <td class="specCriteriaTextLabels">
                                    <bean:message key="label.downloadurl"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="specCriteriaTextLabelsRight" width="300">
                                ...
                                <td class="specCriteriaTextLabels">
                                    <bean:write name="SpecialistForm" property="locationPwd"/>
                                </td>
                            </tr>                                                            
                            <tr><td colspan="2">&nbsp;</td></tr>
                        </table>
