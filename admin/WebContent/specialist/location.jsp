...
<table cellspacing="0" cellpadding="0" border="0" width="1288">
    <tr height="15">
        <td width="2%">&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="2">
                            <table id="dataTable" width="100%" border="0" class="inputsubtable" cellpadding="2" cellspacing="1">
                                ...
                                <tr>
                                    <th class="nicetableheader" width="23">
                                        &nbsp;
                                    </th>
                                    <th class="nicetableheader" width="140">
                                        <bean:message key="label.name"/>
                                    </th>
                                    <th class="nicetableheader" width="68">
                                        <bean:message key="label.status"/>
                                    </th>
                                    <th class="nicetableheader" width="169">
                                        <bean:message key="label.address1"/>
                                    </th>
                                    <th class="nicetableheader" width="169">
                                        <bean:message key="label.address2"/>
                                    </th>
                                    <th class="nicetableheader" width="87">
                                        <bean:message key="label.city"/>
                                    </th>
                                    <th class="nicetableheader" width="150">
                                        <bean:message key="label.state"/>
                                    </th>
                                    <th class="nicetableheader" width="92">
                                        <bean:message key="label.zipcode"/>
                                    </th>
                                    <th class="nicetableheader" width="232">
                            ...
                            <div id="dataTableDiv" style="overflow:auto; width:1288px;height:200px;">
                                <table id="dataTable" width="98.5%" border="0" cellpadding="2" cellspacing="1" >
                                    <nested:iterate id="locationVO" name="SpecialistForm" property="locationVOs" indexId="rowCtr">
                                        <tr>  
                                            ...
                                            <td class="datarowborders" >
                                                <nested:text property="zipCode" maxlength="10" size="12" styleClass="criteriavalue"/>
                                            </td>
                                            <td class="datarowborders" >
