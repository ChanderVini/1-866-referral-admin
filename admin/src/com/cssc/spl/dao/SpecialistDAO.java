...
public class SpecialistDAO {
    ...
    public UserVO fetchAccountInformation (UserVO userVO) throws CSSCApplicationException, CSSCSystemException {
        ...
        try {
            StringBuffer queryBuf = new StringBuffer ("SELECT UT.STATUS US, UT.START_DT USD, UT.END_DT UED, UT.RECURRING_FEE URF, UT.CREATE_DT CD, " +
            ...
            while (rs.next()) {
                ...
                logger.debug ("Status: " + userStatus);
