...
public class UserVO extends CommonVO implements Serializable {
    ...
    private Date activationDt = null;
    private String activationDtStr = "";
    ...
    public String getActivationDtStr() {
        return activationDtStr;
    }

    public void setActivationDtStr(String activationDtStr) {
        this.activationDtStr = activationDtStr;
    }
