            ...
            <div class="tabberlive">
                <ul class="tabbernav">    
                    <li id="login" class="tabberinactive">
                        <a href="user.spl"><bean:message key="label.login"/></a>
                    </li>
    ...
    <tr>
        ...
        <td valign="top">
            <table cellspacing="0" cellpadding="0" border="0" class="inputtable" width="900">
                ...
                <html:form action="/userregsub" method="POST">
                    <tr>
                        <td colspan="2">
                            <table id="dataTable" width="100%" border="0" class="inputsubtable"  cellpadding="0" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="specCriteriaTextLabels">
                                        <html:text name="RegisterForm" property="userVO.zipcode" styleClass="criteriavalue" maxlength="10" size="15"  tabindex="14"/>&nbsp;
