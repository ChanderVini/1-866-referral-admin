...
import com.cssc.spl.struts.form.GenUserForm;
 ...
 */
public class GenUserAction extends Action {
    ...
    private final String GEN_DOWN_MAP = "/userdwn";
    private final String GEN_DOWN_SUB_MAP = "/userdwnsub";
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        GenUserForm generalistForm = (GenUserForm) form;
        ...
        try {
            ...
            GenUserVO generalistVO = (GenUserVO) genProfileObj;
    ...
    private ActionMessages handleDownload (GenUserForm generalistForm, HttpServletRequest request, HttpServletResponse response) throws CSSCApplicationException, CSSCSystemException {
        logger.info ("Start handleDownload (GenUserForm, HttpServletRequest, HttpServletResponse)");
        ActionMessages messages = new ActionMessages ();
        ...
        logger.info ("End handleDownload (GenUserForm, HttpServletRequest, HttpServletResponse)");
        return messages;
    }
    
    private ActionMessages handleFetchDownload (GenUserForm generalistForm, HttpServletRequest request, GenUserVO generalistVO) throws CSSCApplicationException, CSSCSystemException {
        logger.info ("Start handleFetchDownload (GenUserForm, HttpServletRequest, GeneralistVO)");
        ActionMessages messages = new ActionMessages ();
        ...
        logger.info ("End handleFetchDownload (GenUserForm, HttpServletRequest, GeneralistVO)");
        return messages;
    }
    
    private ActionMessages handleFileDownload (GenUserForm generalistForm, HttpServletRequest request, GenUserVO generalistVO) throws CSSCApplicationException, CSSCSystemException {
        logger.info ("Start handleFileDownload (GenUserForm, HttpServletRequest, HttpservletResponse, GeneralistVO)");
        ActionMessages messages = new ActionMessages ();
        ...
        logger.info ("End handleFileDownload (GenUserForm, HttpServletRequest, HttpservletResponse, GeneralistVO)");
        return messages;
    }
}
