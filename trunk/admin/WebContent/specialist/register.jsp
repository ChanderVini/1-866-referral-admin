                ...
                <html:form action="/spcregsub" method="POST">
                        ...
                        <td colspan="2">
                            <table id="dataTable" width="100%" border="0" class="inputsubtable"  cellpadding="0" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="specCriteriaTextLabels">
                                        <html:text name="RegisterForm" property="userVO.zipcode" styleClass="criteriavalue" maxlength="10" size="15"/>&nbsp;
                    ...
                    <tr>
                        ...
                        <table id="dataTable" width="100%" border="0" class="inputsubtable"  cellpadding="0" cellspacing="1">
                            <tr>
                                <td class="specCriteriaTextLabelsRight" width="200">
                                    <bean:message key="label.payoption"/>&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                                </td>
                                <td class="specCriteriaTextLabels">
                                    <html:select name="RegisterForm" property="paymentoption" onchange="handlePaymentOption ()" styleId="paymentoption">
                                        <html:optionsCollection name="RegisterForm" property="paymentoptionBeans"/>
                                    </html:select>
                                </td>
                            </tr>
                            <tr id="amtcharged" style="display:none">
                                <td class="specCriteriaTextLabelsRight" width="200">
                            ...
                            <tr id="payment.check.nbr" style="display:none">
                                <td class="specCriteriaTextLabelsRight" width="200">
                                    <bean:message key="label.checknbr"/>&nbsp;<font color="red">*</font>:&nbsp;&nbsp;
                                </td>
                                <td class="specCriteriaTextLabels" >
                                    <html:text name="RegisterForm" property="checknbr"/>
                                    <html:messages id="error" message="true" property="errors.label.checknbr">
                                        <font color="red"><bean:write name="error"/></font>
                                    </html:messages>
                                </td>
                            </tr>
                            <tr id="payment.check.bankname" style="display:none">
                                <td class="specCriteriaTextLabelsRight" width="200">
                                    <bean:message key="label.bankname"/>&nbsp;<font color="red">*</font>:&nbsp;&nbsp;
                                </td>
                                <td class="specCriteriaTextLabels" >
                                    <html:text name="RegisterForm" property="bankname"/>
                                    <html:messages id="error" message="true" property="errors.label.bankname">
                                        <font color="red"><bean:write name="error"/></font>
                                    </html:messages>
                                </td>
                            </tr>
                            <tr id="paymentdate" style="display:none">
                                <td class="specCriteriaTextLabelsRight" width="200">
                                    <bean:message key="label.date"/>&nbsp;<font color="red">*</font>:&nbsp;&nbsp;
                                </td>
                                <td class="specCriteriaTextLabels" >
                                    <html:text name="RegisterForm" property="paymentdate" styleClass="criteriavalue" readonly="true" styleId="paymentdt"/>
                                    <img src="images/calendar.gif" style="cursor:hand" onclick="javascript:NewCal('paymentdt','MMddyyyy')" width="16" height="16" border="0" alt="Pick a date" id="paymentdate"/>
                                    <html:messages id="error" message="true" property="errors.label.paymentdate">
                                        <font color="red"><bean:write name="error"/></font>
                                    </html:messages>
                                </td>
                            </tr>
                            <tr id="payoption.cc.type" style="display:none">
                                <td  class="specCriteriaTextLabelsRight" width="200">
                                    <bean:message key="label.cctype"/>&nbsp;<font color="red">*</font>:&nbsp;&nbsp;
                                </td>
                                <td class="specCriteriaTextLabels" >
                            ...
                            <tr id="payoption.cc.nbr" style="display:none">
                                <td class="specCriteriaTextLabelsRight">
                            ...
                            <tr  id="payoption.cc.seccode" style="display:none">
                                <td class="specCriteriaTextLabelsRight">
                            ...
                            <tr  id="payoption.cc.expmon" style="display:none">
                                <td class="specCriteriaTextLabelsRight">
                            ...
                            <tr id="payoption.cc.expyear" style="display:none">
                                <td class="specCriteriaTextLabelsRight">
