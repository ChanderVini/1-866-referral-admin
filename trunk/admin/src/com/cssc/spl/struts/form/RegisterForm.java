    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if (REGISTER_SPEC_SUBMIT_MAP.equals (path)) {
            ...
            if (CASH.equals (paymentoption)) {
                ...
                if (Validator.isBlank (paymentdate)) {
                    ActionMessage message = new ActionMessage (CSSC002E);
                    errors.add (ERRORS + ".label.paymentdate", message);
                }
            }
            ...
            if (CHECK.equals (paymentoption)) {
                ...
                if (Validator.isBlank (bankname)) {
                    ActionMessage message = new ActionMessage (CSSC002E);
                    errors.add (ERRORS + ".label.bankname", message);
                }
                if (Validator.isBlank (checknbr)) {
                    ActionMessage message = new ActionMessage (CSSC002E);
                    errors.add (ERRORS + ".label.checknbr", message);
                } 
                if (Validator.isBlank (paymentdate)) {
                    ActionMessage message = new ActionMessage (CSSC002E);
                    errors.add (ERRORS + ".label.paymentdate", message);
