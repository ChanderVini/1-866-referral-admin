    ...
    <tr>
        ...
        <td width="900">
            <div class="tabberlive">
                <ul class="tabbernav">    
                    <logic:equal name="GenUserForm" property="logout" value="true">
                        <li id="login" class="tabberinactive">
                            <html:link action="user.spl"><bean:message key="label.login"/></html:link>
                        </li>
                    </logic:equal>
                    <logic:equal name="GenUserForm" property="logout" value="false">
                        <li id="login" class="tabberinactive">
    ...
    <tr>
        ...
        <td class="labelLeft" valign="top">
            <table cellpadding="0" cellspacing="0" border="0" width="900" class="inputtable">
                ...
                <logic:equal name="GenUserForm" property="operation" value="DWN">
                    <tr>
                        <td valign="top" colspan="2">
                            <html:form action="/userdwnsub" method="POST">
                ...
                <logic:equal name="GenUserForm" property="operation" value="DWNCOM">
                    <tr>
                        <td valign="top" colspan="2">
                            <html:form action="/userdwnsub" method="POST">
                            <table id="dataTable" width="200" border="0" class="inputsubtable" cellpadding="2" cellspacing="0">
